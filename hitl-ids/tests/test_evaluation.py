...
#: The gate needs three verdicts in a family, so a test family needs more than three members for
#: any of them to remain untouched. These numbers are the tests' own, not the rule's defaults.
